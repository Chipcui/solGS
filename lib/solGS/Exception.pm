...
solGS::Exception - expressive exception object for web applications

=head1 SYNOPSIS

  die solGS::Exception->new(
...
The solGS::Exception object is meant to hold a wide variety of
