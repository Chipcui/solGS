package solGS::Role::Site::DBConnector;
use 5.10.0;
...
sub dbc {
	...
	solGS::Role::Site::DBConnector::Connector->new( @{$profile}{qw| dsn user password attributes |} );
...
{ # tiny DBIx::Connector subclass that makes sure search paths are set
  ...
  package solGS::Role::Site::DBConnector::Connector;
  use strict;
  ...
  sub dbh {
      ...
      solGS::Role::Site::DBConnector->ensure_dbh_search_path_is_set( $dbh );
      return $dbh;
  }
}
